...
DEFAULT_RULES = [
    {
        "id": "jaywalking_distracted_risk",
        "name": "Distracted Jaywalking Hazard",
        "severity": "critical",
        "conditions": {
            "road_user_type": "pedestrian",
            "attributes": {"attention": "distracted", "mobility": "moving"},
        },
    },
    {
        "id": "vulnerable_exposure_night",
        "name": "Vulnerable Exposure in Low Light",
        "severity": "high",
        "conditions": {
            "road_user_type": "cyclist",
            "attributes": {"lighting": "low_light", "mobility": "moving"},
        },
    },
    {
        "id": "hidden_group_crossing",
        "name": "Hidden Pedestrian Group (Blind Spot)",
        "severity": "medium",
        "conditions": {
            "road_user_type": "pedestrian",
            "attributes": {"occlusion": "heavy", "group": "group"},
        },
    },
    {
        "id": "erratic_vehicle_behavior",
        "name": "Erratic or Stationed Vehicle in Traffic",
        "severity": "medium",
        "conditions": {
            "road_user_type": "vehicle",
            "attributes": {"mobility": "stationary", "lighting": "low_light"},
        },
    },
]
